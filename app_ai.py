...
st.markdown("""
    ...
    .google-menu-item { font-size: 15px; color: #3c4043; padding: 10px 8px; display: flex; align-items: center; gap: 14px; }
    .google-section-title { font-size: 13px; font-weight: 500; color: #70757a; margin-top: 25px; margin-bottom: 12px; padding-left: 8px; }
    .google-history-item { font-size: 14px; color: #3c4043; padding: 8px 8px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
# 4. MAIN LAYOUT ENGINE (NO IF-STATEMENT BLOCKING)
